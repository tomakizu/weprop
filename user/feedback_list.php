    ...
    $(document).ready(function() {
        ...
        var showContent = function($record_id,$title,$content,$resopnder_id,$action_type) {
            ...
            if($action_type=='responded'){
                ...
                //$('#response_list > tbody:last-child').append('<tr><a href="feedback_details.php?JSONS=' + $record_id + '"' + 'target="popup" onclick="window.open("feedback_details.php?record_id=' + $record_id +'"' + ', "popup", "width=840,height=600"); return false;"> <button type="button" name="button"><?=$view_details?></button> </a></center>');
                $('#response_list  > tbody:last-child').append('<tr><td id="response_listMobile" style="display:none;"><center><a href="feedback_details.php?rId=' + $record_id + '"' + 'target="popup" class="response_listMobile" style="display:none;"> <button type="button" name="button"><?=$view_details?></button> </a></center></td></tr>');

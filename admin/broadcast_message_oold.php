...
<body>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form class="formCss" action="<?=$_SERVER['PHP_SELF']?>" method="post" style="margin: 5% 5% 0 5%">
                    <table border="0">
                        <tr>
                        ...
                        <tr>
                            <td><?=$announcement_email_content?></td>
                            <td><textarea name="email_context" rows="8" cols="80" required><?=$email_context?></textarea></td>
                        </tr>
                    </table>
